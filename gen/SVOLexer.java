...
public class SVOLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PRONOUN", "PRONOUN_SINGULAR", "PRONOUN_I", "DETERMINER", "DETERMINER_SINGULAR", 
	...
	public SVOLexer(CharStream input) {
		super(input);
